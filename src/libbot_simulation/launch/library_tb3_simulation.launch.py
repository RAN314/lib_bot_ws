#!/usr/bin/env python3
# 图书馆机器人导航仿真启动文件
# 完全仿照 nav2_bringup/launch/tb3_simulation_launch.py 实现
...
def generate_launch_description():
    ...
    # 创建启动配置变量 - 完全复制tb3_simulation_launch.py
    ...
    # 声明启动参数 - 完全复制tb3_simulation_launch.py
    ...
    # 启动Gazebo服务器 - 完全复制tb3_simulation_launch.py
