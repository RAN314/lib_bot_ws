...
#
# 图书馆机器人Gazebo仿真启动文件
# 基于turtlebot3_manipulation_gazebo/launch/gazebo.launch.py修改
# 使用aws-robomaker-bookstore-world场景
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([ThisLaunchFileDir(), '/library_manipulation_base.launch.py']),
            launch_arguments={
